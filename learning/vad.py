...
fig0 = report.linplot([vad_envelope.T[0], vad_variance.T[0], vad_fusion.T[0]], 
                      'VAD[Envelope|Variance|Fusion] channel 0')
fig1 = report.linplot([vad_envelope.T[1], vad_variance.T[1], vad_fusion.T[1]], 
                      'VAD[Envelope|Variance|Fusion] channel 1')
